...
{
    /*
    * A class which allows for logging.
    *
    ...
    */
    ...
    public static class Logging
    {
        ...
        /*
        *   FUNCTION    : LogThis()
        *   DESCRIPTION : The function that will be called to write the log to a text file.  The file will automatically create the file based on the date. It wlil take a message from the
