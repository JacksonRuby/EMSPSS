...
namespace Employee
{
    ...
    */
    ...
    public abstract class Employee
    {
        ...
        /**
         *  Sets the first name based on validity.
         *  @param nameToVerify The first name to check and add.
        ...
        /**
         *  Sets the last name based on validity.
         *  @param nameToVerify The last name to check and add.
         *  @return bool Valid or Invalid for true or false.
         */
        ...
        /**
         *  Sets the social insurance number based on validity.
         *  @param newSIN The sin to check and add.
         *  @return bool Valid or Invalid for true or false.
         */
        ...
        /**
         *  Sets the SIN (Business number in this case) based on validity of the date.
         *  @param newSIN The SIN (BN) to verify.
         *  @param newDate The date associated with the BN.
         *  @return bool Valid or Invalid for true or false.
         */
        ...
        /**
         *  Sets the date of birth based on validity.
         *  @param newDate The date of birth to check and add.
         *  @return bool Valid or Invalid for true or false.
         */
